...
const steps = [
  {
    ...
    description: 'Sign up for free with your email. It takes less than 30 seconds to get started and join the community.',
    icon: (
  ...
  },
  {
    ...
    description: 'Share your notes, past questions, solution papers, and PDF documents. Help others while building your own library.',
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'Browse resources uploaded by fellow students. Find exactly what you need for your courses and exams.',
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: 'With the right resources at your fingertips, prepare effectively and walk into every exam with confidence.',
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="container">
        ...
        <div className="hiw__header">
          ...
          <p className="hiw__subtitle">
            From sign-up to exam-ready — here's how Student Resource Hub works for you.
          </p>
        </div>
